...
dp.create_streaming_table(
    name="tweets_gold",
    comment="Tweets enriched with ML sentiment predictions from Unity Catalog model"
)
...
sentiment_udf = mlflow.pyfunc.spark_udf(spark, model_uri, result_type=model_output_schema)
